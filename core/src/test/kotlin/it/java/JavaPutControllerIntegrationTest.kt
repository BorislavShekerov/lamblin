...
import it.java.controller.PutController
import it.runRequestAndVerifyResponse
import org.junit.jupiter.api.Test

class JavaPutControllerIntegrationTest {
    ...
    @Test
    fun `should handle PUT requests with request body`() {
        ...
        runRequestAndVerifyResponse(
                ...
                createRequestInputStream(
                        ...
                        HttpMethod.PUT,
                        body = requestBody),
                expectedResponseBodyContent = "$SIMPLE_REQUEST_BODY_PUT_ENDPOINT-${requestBody.body}")
    }
