...
import it.kotlin.MULTIPLE_PATH_PARAM_PATH_PATCH_ENDPOINT
import it.kotlin.QUERY_PARAM_PARAM_PATCH_ENDPOINT
import it.kotlin.SIMPLE_PATCH_ENDPOINT
import it.kotlin.SIMPLE_REQUEST_BODY_PATCH_ENDPOINT
import it.kotlin.SINGLE_PATH_PARAM_PATH_PATCH_ENDPOINT
...
class PatchController {
    ...
    fun multipleQueryParamTest(
        ...
        return HttpResponse.ok(
                ResponseEntity("$QUERY_PARAM_PARAM_PATCH_ENDPOINT-$queryParam1,$queryParam2"))
    }
    ...
    fun multiplePathParamPath(
        ...
        return HttpResponse.ok(ResponseEntity(
                "$MULTIPLE_PATH_PARAM_PATH_PATCH_ENDPOINT-$pathParamOne,$pathParamTwo"))
    }
    ...
    fun multiplePathParamWithQueryParamsPath(
        ...
        return HttpResponse.ok(ResponseEntity(
                "$MULTIPLE_PATH_PARAM_PATH_PATCH_ENDPOINT-$queryParam,$pathParamOne,$pathParamTwo"))
    }
